...
using NormasService.Api.Logging;
using NormasService.Api.Filters;
using NormasService.Api.Options;
using NormasService.CrossCutting.Assemblies;
using NormasService.CrossCutting.IoC;
